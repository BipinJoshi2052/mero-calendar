    ...
    <script>
        ...
        function initializeDummyData() {
            ...
            transactions.forEach(transaction => {
                ...
                calendarData[dateKey].push({
                    type: transaction.type === 1 ? 'income' :
                    'expense', // Type 1 for income, Type 2 for expense
                    ...
                    .title, // Map to subcategory name if you have subcategory names
            ...
            if (type && categories[type]) {
                categories[type].forEach((category, index) => {
                    ...
                    categorySelect.append(
                        `<option value="${category.id}" data-index="${index}">${category.title}</option>`);
                });
            }

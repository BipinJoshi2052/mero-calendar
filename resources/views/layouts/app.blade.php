                    ...
                    @auth
                        ...
                        <li class="nav-item">
                            <form action="{{ route('logout') }}" method="POST" style="display: inline;">
                                @csrf
                                <button type="submit" class="nav-link" style="text-decoration: none;">Logout</button>
                            </form>
                        </li>
                    @endauth
                </ul>
        ...
        <div class="modal-content">
            ...
            <form id="entryForm">
                ...
                <div class="form-group">
                    ...
                    <select id="entrySubCategory" required>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></script>
    ...
    <script>
        ...
        // ,
        //     event: {
        //         'Personal': ['Meeting', 'Appointment', 'Birthday'],
        //         'Work': ['Conference', 'Deadline', 'Presentation'],
        //         'Social': ['Party', 'Dinner', 'Event'],
        //         'Health': ['Exercise', 'Checkup', 'Therapy']
        //     }
        ...
        function populateSubCategories(type, category) {
            ...
            if (type && category && categories[type] && categories[type][category]) {
                categories[type][category].forEach(subCategory => {
